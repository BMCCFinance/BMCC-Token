...
BINANCE MULTI-CHAIN CAPITAL $BMCC
The team is building an infrastructure of  investing in the most lucrative farms, staking and LP across all blockchain L1 networks.

Regular expenses reporting and investment tracking will be available on each stage of the development.
...
Social
Twitter httpstwitter.combinancemcc
Telegram httpst.meBINANCEMCC
...
contract BMCC is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1e12  109;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private constant _name = unicodeBINANCE MULTI-CHAIN CAPITAL;
    string private constant _symbol = unicodeBMCC;
